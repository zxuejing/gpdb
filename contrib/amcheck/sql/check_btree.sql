...
SELECT bt_index_parent_check('bttest_b_idx');
-- GPDB
SELECT bt_index_check('bttest_a_idx') from gp_dist_random('gp_id');
SELECT bt_index_parent_check('bttest_b_idx') from gp_dist_random('gp_id');
...
SELECT bt_index_check('bttest_a_ao_idx') from gp_dist_random('gp_id');
SELECT bt_index_parent_check('bttest_b_ao_idx') from gp_dist_random('gp_id');
-- corrupt the file
...
SELECT bt_index_check('bttest_a_aocs_idx') from gp_dist_random('gp_id');
SELECT bt_index_parent_check('bttest_b_aocs_idx') from gp_dist_random('gp_id');
-- corrupt the file
