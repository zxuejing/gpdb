...
ProcessAndClauseForPossibleValues( PredIterInfoData *clauseInfo, Node *clause, Node *variable, Oid policy_opfamily)
{
	...
	{
		PossibleValueSet childPossible = DeterminePossibleValueSet( child, variable, policy_opfamily );
 ...
 */
static PossibleValueSet
ProcessOrClauseForPossibleValues( PredIterInfoData *clauseInfo, Node *clause, Node *variable, Oid pilicy_opfamily)
{
	PossibleValueSet result;
	InitPossibleValueSetData(&result);
	...
	iterate_begin(child, clause, *clauseInfo)
	{
		PossibleValueSet childPossible = DeterminePossibleValueSet( child, variable, pilicy_opfamily);
		if ( childPossible.isAnyValuePossible)
		{
 ...
 */
PossibleValueSet
DeterminePossibleValueSet(Node *clause, Node *variable, Oid policy_opfamily)
{
	...
	{
		case CLASS_AND:
			return ProcessAndClauseForPossibleValues(&clauseInfo, clause, variable, policy_opfamily);
		case CLASS_OR:
			return ProcessOrClauseForPossibleValues(&clauseInfo, clause, variable, policy_opfamily);
		case CLASS_ATOM:
			if (TryProcessExprForPossibleValues(clause, variable, policy_opfamily, &result))
			{
				return result;
			}
