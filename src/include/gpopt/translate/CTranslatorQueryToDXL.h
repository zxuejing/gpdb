...
private:
	...
	CTranslatorQueryToDXL(
		...
		CIdGenerator *m_colid_counter, CIdGenerator *cte_id_counter,
		CMappingVarColId *var_colid_mapping, Query *query, ULONG query_level,
	...
	CDXLNodeArray *TranslateSortColumnsToDXL(
