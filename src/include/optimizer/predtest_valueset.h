...
extern PossibleValueSet DeterminePossibleValueSet(Node *clause, Node *variable, Oid policy_opfamily);
...
extern bool TryProcessExprForPossibleValues(Node *expr, Node *variable, Oid policy_opfamily, PossibleValueSet *resultOut);
